      ...
      <div className="flex flex-col md:flex-row items-start gap-5">
        ...
        <aside className="w-max md:w-[200px]">
          <div className="flex md:flex-col gap-3 mx-3">
            <button
              ...
              className={`block w-full text-left font-semibold text-lg px-4 py-3 rounded ${
                filtroGenero === "todos"
                  ? "bg-black text-white"
        ...
        <div className="flex-1">
          ...
          <div className="overflow-y-auto snap-y snap-mandatory max-h-[120vh]">
            <div className="grid grid-cols-2 md:grid-cols-4 md:gap-[15px] gap-3 sm:p-3 transition-all duration-500">
              {produtosSubFiltrados.map((product) => (
                <Link to={`produto/${product.id}`}>
                  <div
                    key={product.id}
                    className="snap-start flex-shrink-0 bg-white rounded-2xl shadow-lg 
